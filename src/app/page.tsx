...
export default async function DashboardPage() {
  ...
  const stats = [
    { label: "שחקנים פעילים", value: data.activePlayersCount, icon: UserCheck, href: "/players?status=ACTIVE_CLIENT" },
    { label: 'סה"כ שחקנים', value: data.totalPlayers, icon: Users, href: "/players" },
    { label: "משימות פתוחות", value: data.openTasksCount, icon: ListChecks, href: "/tasks" },
    { label: "שחקנים קריטיים", value: data.criticalPlayersCount, icon: AlertTriangle, href: "/players" },
    { label: 'עסקאות פתוחות', value: data.openDealsCount, icon: Briefcase, href: "/players" },
    { label: "מידע חסר", value: data.missingInfoCount, icon: FileWarning, href: "/players" },
  ];
