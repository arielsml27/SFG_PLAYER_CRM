  ...
  return (
    <form action={action} className="stack">
      ...
      <div className="panel stack">
        ...
        <div className="form-grid">
          <Field label="קראט">
            <select name="karat" defaultValue={product?.karat ?? "18K"}>
              {KARATS.map((k) => (
          ...
          <Field label="מחיר לקראט ($)">
            <input type="number" name="centerPricePerCt" step="1" min="0" defaultValue={product?.centerPricePerCt ?? 0} />
          </Field>
        ...
        <div className="form-grid">
          ...
          <Field label="מחיר לקראט ($)">
            <input type="number" name="sidePricePerCt" step="1" min="0" defaultValue={product?.sidePricePerCt ?? 0} />
          </Field>
          <Field label="קראט צד">
      ...
      <div className="panel stack">
        ...
        <div className="form-grid">
          <Field label="עבודת צורף ($)">
            <input type="number" name="goldsmithCost" step="1" min="0" defaultValue={product?.goldsmithCost ?? 0} />
          </Field>
          <Field label="שיבוץ מרכזית — לאבן ($)">
            <input type="number" name="centerSettingPrice" step="1" min="0" defaultValue={product?.centerSettingPrice ?? 0} />
          </Field>
          <Field label="כמות">
            <input type="number" name="centerSettingQty" step="1" min="0" defaultValue={product?.centerSettingQty ?? 0} />
          </Field>
          <Field label="שיבוץ צד — לאבן ($)">
            <input type="number" name="sideSettingPrice" step="0.5" min="0" defaultValue={product?.sideSettingPrice ?? 0} />
          </Field>
          <Field label="כמות">
            <input type="number" name="sideSettingQty" step="1" min="0" defaultValue={product?.sideSettingQty ?? 0} />
          </Field>
          <Field label="רודיום ($)">
            <input type="number" name="rhodiumCost" step="1" min="0" defaultValue={product?.rhodiumCost ?? 0} />
          </Field>
          <Field label="קופסא ($)">
            <input type="number" name="boxCost" step="0.5" min="0" defaultValue={product?.boxCost ?? 0} />
          </Field>
          <Field label="שקית ($)">
            <input type="number" name="bagCost" step="0.5" min="0" defaultValue={product?.bagCost ?? 0} />
          </Field>
          <Field label="אריזה ($)">
            <input type="number" name="packagingCost" step="0.5" min="0" defaultValue={product?.packagingCost ?? 0} />
          </Field>
        </div>
      </div>
      ...
      <div className="panel stack">
        ...
        <div className="form-grid">
          ...
          <Field label="מחיר קמעונאי קבוע ($)" hint="ריק = לפי המכפיל ושערי היום">
            <input type="number" name="priceRetailUsd" step="1" min="0" defaultValue={product?.priceRetailUsd ?? ""} />
          </Field>
          <Field label="מחיר סיטונאי ($)">
            <input type="number" name="priceWholesaleUsd" step="1" min="0" defaultValue={product?.priceWholesaleUsd ?? ""} />
          </Field>
        </div>
