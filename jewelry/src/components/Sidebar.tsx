...
type Counts = { orders: number; customers: number; tasks: number; catalog: number; workOrders: number };
...
const NAV = [
  ...
  { group: "ייצור", items: [
    { href: "/work-orders", label: "הזמנות עבודה", key: "workOrders" as const },
    { href: "/suppliers", label: "ספקים ומפעלים", key: null },
  ]},
  { group: "מוצרים", items: [
