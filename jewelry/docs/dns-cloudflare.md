...
Cloudflare מייבאת אותן בכל זאת, ו**מדליקה עליהן פרוקסי** (ענן כתום).
זה גרוע מלהשאיר אותן: פרוקסי על רשומה שמצביעה לאחסון Squarespace גורם
לשגיאת SSL או לדף ״הדומיין לא מחובר״. מוחקים.

- [ ] מחק את ארבע רשומות ה-`A`
- [ ] מחק את `CNAME www`
- [ ] מחק את `CNAME _domainconnect`
...
> **שלוש הרשומות שנשארות חייבות להיות `DNS only` (ענן אפור).** MX ו-TXT
> אינן ניתנות לפרוקסי בכלל, ולכן Cloudflare כבר מסמנת אותן נכון.
